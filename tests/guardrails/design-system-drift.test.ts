...
const MIGRATED_PAGES = [
    ...
    // MCP admin hub — token-clean from the start (semantic tokens +
    // PageHeader/Link/Nucleo icons only; no raw color utilities, no
...
describe('New page token discipline', () => {
    ...
    it('tracks unmigrated page count (should decrease over time)', () => {
        ...
        //   - 126 (+2): NIS2 gap delegation (Prompt 2) — audits/nis2-gap/respond/
