...
import { getInitiativesForWidget } from '@/app-layer/usecases/org-security-initiative';
    ...
    return (
        <PortfolioDashboard
            ...
            data={toPlainJson({
                ...
                initiatives,
                canManageInitiatives: ctx.permissions.canConfigureDashboard,
            })}
