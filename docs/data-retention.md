...
This document categorizes **every one of the 145 Prisma models**, declares the
...
| Operational | 22 | Notifications, executions, snapshots, key-sequences, onboarding. No TTL today — prime candidates for time-boxed pruning. |
